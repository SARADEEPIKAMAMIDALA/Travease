...
import UserTourTable from "./Pages/Tour/UserTourTable.js";
...
import UserSearchByDuration from "./Pages/Tour/UserSearchByDuration.js";
function App() {
  return (
    <>
      <Router>
        ...
        <Routes>
          ...
          {/* user functionality */}
          <Route path="/addTour" exact element={<AddTour/>} />
        ...
        <Route path="/login" element={<SignIn />} />
          ...
          <Route path="/getbydestination/" element={<UserSearchByDestination />} />
          <Route path="/getbyduration" element={<UserSearchByDuration />} />
          ...
          <Route path="/searchbydestination/" element={<SearchByDestination />} />
